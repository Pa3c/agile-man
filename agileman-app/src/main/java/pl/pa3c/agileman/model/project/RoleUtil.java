...
public class RoleUtil {
	...
	public enum SCRUM {
		COMMON,TESTER, SCRUM_MASTER, DEV, PRODUCT_OWNER, LEADER, CUSTOMER,PROJECT_SUPER_ADMIN,PROJECT_BASIC
	}

	public enum XP {
		COMMON,TESTER, DEV, PRODUCT_OWNER, CUSTOMER,PROJECT_SUPER_ADMIN,PROJECT_BASIC
	}

	public enum KANBAN {
		COMMON,TESTER, DEV, PRODUCT_OWNER, LEADER, CUSTOMER,PROJECT_SUPER_ADMIN,PROJECT_BASIC
	}
